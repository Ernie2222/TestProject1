...
public class Class_activity {
	...
	public static void activity1() {
		...
		// 1. Then get the second window id and store it in variable called
		// secondWindowId.
		...
		String seconWindowId = iterate.next();
		// 5. Switch to the second window
		driver.switchTo().window(seconWindowId);
		...
		// 7. Close the window, Switch back to the main window, Verify you are on the
		// main window.
		driver.close();
